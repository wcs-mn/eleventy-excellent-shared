...
## Using as a shared package

This repo doubles as a shared base package for multiple Eleventy sites.
Install it in a consumer site via:

  npm install github:wcs-mn/eleventy-excellent-shared

Then in your site's eleventy.config.js:
...
Any file in your site's src/ at the same relative path as a file in this
package's src/ will automatically override the shared version. No
configuration needed — Eleventy resolves the site's own input directory first.
