/**
 * Shared Eleventy plugin entry point for consumer sites.
 * Use: eleventyConfig.addPlugin(sharedConfig)
 *
...
export default async function sharedConfig(eleventyConfig, options = {}) {
  // --------------------- Events: before build
